...
const ProjectPage = () => {
  ...
  const projectDetails = {
    ...
    tabventure: {
      ...
      desc: "Tabventure is a browser extension application that has the ability to summarize the content of the currently open tabs. This was a collaborative project completed by a team of 4 developers during a hackathon. This is incredibly useful for someone who tends to open many tabs to look at multiple outlets of information regarding their trip. When activated, the extension displays a window housing a virtualized AI assistant specifically designed to answer questions based on the open browser tabs. This allows for online trip planning to become streamlined and alleviates the hassle of dealing with multiple open tabs yourself.",
      ...
      nextProjectId: "worduno",
      prevProjectId: "capsy",
    },
    worduno: {
      type: "Web Development",
      title: "Worduno",
      subtitle: "AI-Powered Text Simplifier",
      desc: "Worduno is a Google Chrome extension that allows users to highlight difficult text and simplify it with one click. ",
      media: ["/images/worduno-product-page.png", "/videos/worduno-demo.mp4"],
      link: "https://chromewebstore.google.com/detail/worduno-text-simplifier/clkioiobgdmiefidhflfgocnflmdaefd",
      tech: "React, Flask, Python, OpenAI, JavaScript",
      nextProjectId: "split",
